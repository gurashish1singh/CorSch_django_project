...
SECRET_KEY = '88f))k^jev4$yf0rti(0c3ibch%g__#_ar5zu56=a2=jby)p30'
...
# EMAIL_HOST_USER = 'singh1gurashish@gmail.com'
# EMAIL_HOST_PASSWORD = 'Summit@0521'
DEFAULT_FROM_EMAIL = os.environ.get('EMAIL_USER_EMAIL')
